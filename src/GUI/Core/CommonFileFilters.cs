...
public static class CommonFileFilters
{
	...
	public static List<FileBrowserFilter> JsonList { get; private set; } =
	[
		Json,
		All
	];
	...
	public static List<FileBrowserFilter> MarkdownConverterFilesList { get; private set; } =
	[
	...
	public static List<FileBrowserFilter> DefaultFilters { get; set; } =
	[
