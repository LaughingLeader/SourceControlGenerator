...
public class MarkdownFormatterData : ReactiveObject
{
	...
	private readonly MarkdownConverterViewData parentViewData;
	...
	public MarkdownFormatterData(MarkdownConverterViewData parentData = null)
	{
		...
		{
			var invokeSave = lastSavedPath != FilePath || (String.IsNullOrWhiteSpace(FilePath) && !String.IsNullOrWhiteSpace(FilePath));
