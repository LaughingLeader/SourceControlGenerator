...
/// Source: https://github.com/T-Alex/WPFControls
/// MIT License
/// </summary>
...
public class NumericUpDown : Control
{
	...
	{
		var newIncrement = (decimal)value;
		var control = (NumericUpDown)element;

		var coercedNewIncrement = Decimal.Round(newIncrement, control.DecimalPlaces);
	...
	{
		var formatInfo = (NumberFormatInfo)NumberFormatInfo.Clone();
		formatInfo.NumberGroupSeparator = String.Empty;

		var formattedValue = Value.ToString("F" + DecimalPlaces, formatInfo);
