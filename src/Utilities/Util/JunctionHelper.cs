...
/// Source: https://www.codeproject.com/Articles/15633/Manipulating-NTFS-Junction-Points-in-NET
/// </summary>
public static class JunctionHelper
{
	...
	public static void Create(string sourceDir, string targetDir, bool overwrite = false, bool makeReadOnly = false)
	{
		...
		using (var handle = OpenReparsePoint(targetDir, EFileAccess.GenericWrite))
		{
			var sourceDirBytes = Encoding.Unicode.GetBytes(NonInterpretedPathPrefix + Path.GetFullPath(sourceDir));
