...
{
	public ObservableCollectionExtended<ILocaleKeyEntry> Entries { get; set; } = [];

	private readonly ReadOnlyObservableCollection<ILocaleKeyEntry> visibleEntries;
	...
	public List<LocaleUnsavedChangesData> UnsavedChanges = [];
