...
public partial class DOS2DEProjectsView : DOS2DEProjectsViewBase
{
	...
	public DOS2DEProjectsView()
	{
		...
		if (DesignerProperties.GetIsInDesignMode(this))
		{
			ViewModel = new DOS2DEModuleData
			{
				...
				LoadPanelVisibility = Visibility.Collapsed
			};
		}
	...
	{
		var list = (ListBox)this.FindName("AvailableProjectsList");
		if (list != null)
		{
	...
	public void ToggleAvailableProjectsView(bool? NextValue = null)
	{
		...
		if (grid != null)
		{
			var nextValue = Controller.Data.AvailableProjectsVisible;
			if (NextValue != null)
			{
	...
	{
		var canGitGenerate = false;
		var projectSelected = false;

		var managedGrid = (DataGrid)this.FindName("ManagedProjectsDataGrid");
	...
	private void ManagedProjectsDataGrid_Loaded(object sender, RoutedEventArgs e)
	{
		...
		{
			var availableSpace = this.ActualWidth;
	...
	private void CreateTestData()
	{
		...
		for (var i = 0; i < 4; i++)
		{
			...
			{
				ModuleInfo = new SCG.Data.Xml.ModuleInfo()
				{
					Name = "Test" + i,
					Author = "LaughingLeader"
				},
				ProjectInfo = new SCG.Data.Xml.ProjectInfo(),
				IsManaged = true,
	...
	private List<ModProjectData> CreateTestProjects()
	{
		...
		if (Directory.Exists(dataDirectory))
		{
			...
			{
				var modsRoot = new DirectoryInfo(modsPath);
